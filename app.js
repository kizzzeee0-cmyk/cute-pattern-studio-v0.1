...
const STORAGE={state:'cps-v150-state',favorites:'cps-v150-favorites',presets:'cps-v150-presets',assets:'cps-v150-assets'};
const MAX_LAYERS=8;
const AI_EXAMPLES=[
...
function normalizeAiSuggestion(suggestion,index=0){
  ...
  let bg={transparent:false,mode:'solid',colors:[...defaultBg],gradientAngle:135,gradientStops:buildGradientStopsFromColors(defaultBg),...(safe.bg||{})};
...
function makeInitialState(){return {bg:{transparent:false,mode:'solid',colors:[...defaultBg],gradientAngle:135,gradientStops:buildGradientStopsFromColors(defaultBg)},exportW:2000,exportH:2000,tileW:512,tileH:512,layers:[defaultLayer(0,'pastel-checker',true)]}}
